                        ...
                        <div class="card" style="border-radius: 6px !important;">
                            <div class="card-header">
                                <div class="flex justify-between items-center">
                                    ...
                                    <button class="btn btn-primary1" onclick="window.location.href='/meta/add-meta'">
                                        <i class="fa fa-circle-plus mr-2"></i>Add Meta
                                    </button>
                                </div>
                            </div>
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="action-buttons">
                                                            <!-- /hr/employee/edit/<?= $data['id'] ?> -->
                                                            <a href="/meta/edit-meta/<?= $data['id'] ?>"
                                                                class="action-button edit">
                                                                <i class="fa fa-edit"></i>
                                                            </a>
                                                            <a onclick="return confirm('Are you sure ?')"
                                                                href="/meta/delete-meta/<?= $data['id'] ?>"
