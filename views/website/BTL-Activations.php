...
<body>
    <section class="relative pt-40 pb-32 bg-[#172010] overflow-hidden min-h-[85vh] flex items-center">
        ...
        <div class="w-[80vw] max-md:w-[90vw] mx-auto md:px-4 relative z-10">
            <div class="max-w-4xl">
                ...
                <h1 class="text-3xl md:text-8xl font-black text-white leading-[0.9] uppercase mb-8">
                    BTL & <br>
                    <span class="text-[#a3e635]">Activations</span>
                </h1>

                <p class="text-gray-300 text-sm md:text-xl max-w-2xl border-l-4 border-[#a3e635] pl-8 max-md:pl-4 mb-12 drop-shadow-lg">
                ...
                <div class="flex flex-wrap gap-5">
                    <a href="/services" class="px-10 py-4 max-md:py-3 bg-[#a3e635] text-black font-bold uppercase text-[10px] tracking-widest rounded-full hover:shadow-[0_10px_30px_rgba(163,230,53,0.3)] hover:scale-105 transition-all">
                        View Activation Types
                    </a>
                    <a href="/contact" class="px-10 py-4 max-md:py-3 border border-white/20 text-white font-bold uppercase text-[10px] tracking-widest rounded-full hover:bg-white/10 transition backdrop-blur-sm">
                        Get Started
                    </a>
                </div>
            </div>
    ...
    <section id="solutions" class="py-24 max-md:py-14 bg-[#0d1309]">
        <div class="w-[80vw] max-md:w-[90vw] mx-auto md:px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="p-10 max-md:p-6 bg-[#172010] rounded-3xl border border-white/5 hover:border-brand-accent/40 transition-all group">
                    ...
                    <h3 class="text-2xl max-md:text-xl font-bold text-white mb-4 uppercase">Mall Activations</h3>
                ...
                <div class="p-10 max-md:p-6 bg-[#172010] rounded-3xl border border-white/5 hover:border-brand-accent/40 transition-all group">
                    ...
                    <h3 class="text-2xl max-md:text-xl font-bold text-white mb-4 uppercase">Corporate & RWA</h3>
                ...
                <div class="p-10 max-md:p-6 bg-[#172010] rounded-3xl border border-white/5 hover:border-brand-accent/40 transition-all group">
                    ...
                    <h3 class="text-2xl max-md:text-xl font-bold text-white mb-4 uppercase">Sampling & Demos</h3>
    ...
    <section id="impact" class="py-24 max-md:py-14 bg-[#0d1309] relative overflow-hidden">
        <div class="w-[80vw] max-md:w-[90vw] mx-auto md:px-4 flex flex-col md:flex-row items-center justify-between gap-12">
            <div class="max-w-md">
    ...
    <section class="py-24 max-md:py-14 bg-[#172010]">
        <div class="w-[80vw] max-md:w-[90vw] mx-auto md:px-4">
            <div class="bg-gradient-to-r from-[#172010] to-[#1e2a15] border border-brand-accent/20 rounded-[4rem] p-8 md:p-20 flex flex-col items-center text-center">
                <h2 class="text-3xl md:text-5xl font-black text-white uppercase mb-8">Let's Get Your Brand <br><span class="text-brand-accent">On the Street</span></h2>
                <p class="text-gray-400 mb-12 max-w-xl max-md:text-sm italic">"From Thane to the rest of India, we manage the logistics so you can focus on the leads."</p>
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="/contact" class="px-12 max-md:px-8 py-5 max-md:py-3 bg-brand-accent text-black font-black uppercase text-xs tracking-widest rounded-full hover:scale-105 transition-transform">Inquire for Activation</a>
                    <a href="/services" class="px-12 py-5 max-md:py-3 border border-white/20 text-white font-black uppercase text-xs tracking-widest rounded-full hover:bg-white/5 transition-all">View Gallery</a>
                </div>
            </div>
        </div>
    </section>
