...
<body>
    <!-- <section class="relative pt-32 pb-20 bg-[#172010] overflow-hidden">
        ...
        <div class="w-[80vw] mx-auto px-4 relative z-10 text-center">
            <div class="inline-block px-4 py-1.5 border border-brand-accent/30 rounded-full bg-brand-accent/5 mb-8">
            ...
            <h1 class="text-6xl md:text-8xl font-black text-white leading-none uppercase mb-8">
                ...
                <span class="relative">
                    Technology
                    <span class="absolute -bottom-2 left-0 w-full h-2 bg-brand-accent/20"></span>
                </span>
            </h1>
            ...
            <div class="flex flex-wrap justify-center gap-6">
                <a href="/services" class="px-10 py-4 bg-brand-accent text-black font-bold uppercase text-[10px] tracking-widest rounded-full hover:shadow-[0_0_30px_rgba(163,230,53,0.4)] transition-all">Our Tech Stack</a>
    ...
    <section class="relative pt-40 pb-32 bg-[#172010] overflow-hidden min-h-[85vh] flex items-center">
        ...
        <div class="w-[80vw] mx-auto px-4 relative z-10">
            <div class="max-w-3xl">
                ...
                <p class="text-gray-300 text-lg md:text-xl leading-relaxed mb-12 border-l-4 border-[#a3e635] pl-6">
                    Bridging the gap between traditional OOH and modern performance marketing with measurable, result-oriented tech solutions.
                </p>
    ...
    <section id="solutions" class="py-24 bg-[#0d1309]">
        <div class="w-[80vw] mx-auto px-4">
            <div class="grid md:grid-cols-3 gap-0 border border-white/10 rounded-[2rem] overflow-hidden">
                ...
                <div class="p-12 bg-[#172010] border-r border-white/10 hover:bg-brand-accent/5 transition-colors group">
                ...
                <div class="p-12 bg-[#172010] hover:bg-brand-accent/5 transition-colors group">
                    <div class="text-brand-accent mb-8 group-hover:scale-110 transition-transform duration-500">
                        <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section class="py-24 bg-[#172010] relative overflow-hidden">
        <div class="w-[80vw] mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
            <div>
    ...
    <section class="py-24 bg-[#0d1309]">
        <div class="w-[80vw] mx-auto px-4">
            <div class="bg-gradient-to-br from-[#172010] to-[#0d1309] border-2 border-brand-accent/30 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
                ...
                <h2 class="text-4xl md:text-5xl font-black text-white uppercase mb-8">Upgrade Your Brand's <br><span class="text-brand-accent">Digital Intelligence</span></h2>
                <p class="text-gray-400 mb-12 max-w-lg mx-auto">From Thane to a global stage—let’s build a digital presence that outshines the competition.</p>

                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="/contact" class="px-12 py-5 bg-brand-accent text-black font-black uppercase text-sm tracking-widest rounded-full hover:scale-105 transition-all">Start My Audit</a>
                    <a href="/services" class="px-12 py-5 border border-white/20 text-white font-black uppercase text-sm tracking-widest rounded-full hover:bg-white/5 transition-all">View Case Studies</a>
                </div>
            </div>
        </div>
    </section>
