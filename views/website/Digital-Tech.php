...
<body>
    ...
    <section id="solutions" class="py-24 max-md:py-14 bg-brand-gray">
        <div class="w-[80vw] max-md:w-[90vw] mx-auto md:px-4">
            <div class="grid md:grid-cols-3 gap-0 border border-gray-200 bg-brand-light rounded-[2rem] overflow-hidden shadow-sm">

                <div class="p-12 max-md:p-6 border-r border-gray-100 hover:bg-brand-accent/5 transition-colors group">
                    ...
                    <h3 class="text-2xl font-bold text-brand-dark mb-4 uppercase">Search & SEO</h3>
                ...
                <div class="p-12 max-md:p-6 border-r border-gray-100 hover:bg-brand-accent/5 transition-colors group">
                    ...
                    <h3 class="text-2xl font-bold text-brand-dark mb-4 uppercase">Social Marketing</h3>
                ...
                <div class="p-12 max-md:p-6 hover:bg-brand-accent/5 transition-colors group">
                    <div class="text-brand-accent mb-8 group-hover:scale-110 transition-transform duration-500">
                        <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-2xl font-bold text-brand-dark mb-4 uppercase">Brand Technology</h3>
    ...
    <section class="py-24 max-md:py-14 bg-brand-light relative overflow-hidden">
        <div class="w-[80vw] max-md:w-[90vw] mx-auto md:px-4 grid lg:grid-cols-2 gap-16 items-center">
            <div>
                <h2 class="text-4xl font-black text-brand-dark uppercase mb-8 leading-tight">If it can't be measured, <br><span class="text-brand-accent">it doesn't count.</span></h2>
                <p class="text-gray-500 mb-8 italic">"Unlike traditional agencies, we provide a unified dashboard that tracks your OOH impressions alongside your digital conversions."</p>

                <div class="space-y-4">
                    <div class="flex items-center gap-4 p-4 bg-brand-gray rounded-xl border border-gray-200">
                        <div class="w-2 h-2 rounded-full bg-brand-accent animate-pulse"></div>
                        <span class="text-brand-dark text-sm font-semibold uppercase tracking-widest">Real-time Analytics Tracking</span>
                    </div>
                    <div class="flex items-center gap-4 p-4 bg-brand-gray rounded-xl border border-gray-200">
                        <div class="w-2 h-2 rounded-full bg-brand-accent"></div>
                        <span class="text-brand-dark text-sm font-semibold uppercase tracking-widest">Conversion Rate Optimization (CRO)</span>
                    </div>
                    <div class="flex items-center gap-4 p-4 bg-brand-gray rounded-xl border border-gray-200">
                        <div class="w-2 h-2 rounded-full bg-brand-accent"></div>
                        <span class="text-brand-dark text-sm font-semibold uppercase tracking-widest">Unified Omnichannel Reporting</span>
                    </div>
                </div>
            </div>
            ...
            <div class="relative">
                ...
                <div class="relative bg-white border border-gray-100 rounded-3xl p-8 shadow-2xl">
                    <div class="flex items-end gap-2 h-40 mb-6">
                        ...
                        <div class="flex-1 bg-gray-100 h-[50%] rounded-t-lg transition-all hover:h-[90%] hover:bg-brand-accent"></div>
                        <div class="flex-1 bg-brand-accent h-[70%] rounded-t-lg shadow-lg shadow-brand-accent/20"></div>
                        <div class="flex-1 bg-gray-100 h-[40%] rounded-t-lg transition-all hover:h-[60%] hover:bg-brand-accent"></div>
                        <div class="flex-1 bg-gray-100 h-[60%] rounded-t-lg transition-all hover:h-[100%] hover:bg-brand-accent"></div>
                    </div>
                    <div class="flex justify-between items-center border-t border-gray-100 pt-6">
                        <div>
                            <p class="text-gray-400 text-[10px] uppercase font-bold tracking-widest">Campaign Growth</p>
                            <p class="text-brand-dark text-2xl font-black">+240%</p>
                        </div>
    ...
    <section class="py-24 max-md:py-14 bg-brand-gray">
        <div class="w-[80vw] max-md:w-[90vw] mx-auto md:px-4">
            <div class="bg-gradient-to-br from-brand-light to-brand-accentLight/30 border-2 border-brand-accent/20 rounded-[3rem] p-8 md:p-20 text-center relative overflow-hidden shadow-lg">
                ...
                <p class="text-gray-500 mb-12 max-w-lg max-md:text-sm mx-auto">From Thane to a global stage—let’s build a digital presence that outshines the competition.</p>
