...
<body>
    ...
    <section class="relative pt-40 pb-32 bg-[#172010] overflow-hidden min-h-[80vh] flex items-center">
        ...
        <div class="w-[80vw] mx-auto px-4 relative z-10">
            <div class="max-w-3xl">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="/services" class="px-8 py-4 bg-[#a3e635] text-black font-bold uppercase text-xs tracking-widest rounded-full hover:scale-105 hover:shadow-[0_0_30px_rgba(163,230,53,0.4)] transition-all">
                        Explore Inventory
                    </a>
                    <a href="/contact" class="px-8 py-4 border border-white/40 text-white font-bold uppercase text-xs tracking-widest rounded-full hover:bg-white/10 transition backdrop-blur-sm">
                        Get Started
                    </a>
                </div>
            </div>
    ...
    <section id="inventory" class="py-24 bg-[#0d1309]">
        <div class="w-[80vw] mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="group relative overflow-hidden rounded-2xl bg-brand-accent p-8 shadow-[0_20px_50px_rgba(163,230,53,0.2)] transition-all duration-500">
                    <div class="h-48 mb-6 overflow-hidden rounded-lg bg-black/10">
                    ...
                    <h3 class="text-2xl font-bold text-[#172010] mb-3">Digital Screens (DOOH)</h3>
                    <ul class="text-[#172010]/80 space-y-2 text-sm font-medium">
    ...
    <section class="py-24 bg-[#0d1309] relative">
        <div class="w-[80vw] mx-auto px-4 grid md:grid-cols-2 items-center gap-20">
            ...
            <div>
                <h2 class="text-4xl font-bold text-white uppercase mb-8 leading-tight">Beyond Just <span class="text-brand-accent">Space Selling</span></h2>
                <div class="space-y-6">
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="text-white font-bold mb-1">Data-Driven Site Selection</h4>
                            <p class="text-gray-400 text-sm italic">We use heatmaps and mobility data to ensure your billboard is where your target audience lives and moves.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="text-white font-bold mb-1">Creative Optimization</h4>
                            <p class="text-gray-400 text-sm">Our 360-degree expertise means we design content specifically for OOH—bold, readable, and unforgettable.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        ...
                        <div>
                            <h4 class="text-white font-bold mb-1">End-to-End Execution</h4>
                            <p class="text-gray-400 text-sm">From printing and fabrication to 24/7 lighting maintenance and campaign photography.</p>
                        </div>
                    </div>
                </div>
            </div>
